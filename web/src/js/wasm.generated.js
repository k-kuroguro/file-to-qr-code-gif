...
// source-hash: 4e72992de48d2b4e1e497b673633e1064085f02a
let wasm;
 ...
 * @returns {Uint8Array}
 */
export function generate_gif(file, version) {
   try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      _assertClass(file, File);
      wasm.generate_gif(retptr, file.__wbg_ptr, version);
 ...
 * @returns {File}
 */
export function decode_to_file(buf) {
   try {
      const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
      const ptr0 = passArray8ToWasm0(buf, wasm.__wbindgen_malloc);
      const len0 = WASM_VECTOR_LEN;
      wasm.decode_to_file(retptr, ptr0, len0);
      var r0 = getInt32Memory0()[retptr / 4 + 0];
      var r1 = getInt32Memory0()[retptr / 4 + 1];
      var r2 = getInt32Memory0()[retptr / 4 + 2];
      if (r2) {
...
export class File {
   ...
   get buf() {
      try {
         const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
         wasm.file_buf(retptr, this.__wbg_ptr);
         var r0 = getInt32Memory0()[retptr / 4 + 0];
         var r1 = getInt32Memory0()[retptr / 4 + 1];
         var v1 = getArrayU8FromWasm0(r0, r1).slice();
         wasm.__wbindgen_free(r0, r1 * 1, 1);
 ...
 *   exports: { generate_gif: typeof generate_gif; decode_to_file: typeof decode_to_file; File : typeof File  }
 * }>}
 */
...
function getWasmInstanceExports() {
   return { generate_gif, decode_to_file, File };
}
